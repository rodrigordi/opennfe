...
namespace RDI.NFe2.Business.PWS.SVRS.Status
{
    ...
    public partial class NfeStatusServico2 : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public NfeStatusServico2()
        {
            ...
            this.Url = "https://nfe.svrs.rs.gov.br/ws/NfeStatusServico/NfeStatusServico2.asmx"; //works
            //this.Url = "https://200.233.14.141/ws/NfeStatusServico/NfeStatusServico2.asmx"; //doesnt work
