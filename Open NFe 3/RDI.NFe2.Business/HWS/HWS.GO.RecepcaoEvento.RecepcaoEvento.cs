...
namespace RDI.NFe2.Business.HWS.GO.RecepcaoEvento
{
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name = "RecepcaoEventoServiceBinding", Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento")]
    public partial class RecepcaoEvento : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public RecepcaoEvento()
        {
            ...
            this.Url = "https://homolog.sefaz.go.gov.br/nfe/services/v2/RecepcaoEvento";
        }
